...
1. **[Information Protection]** ページの左側のサイドバーで、**[秘密度ラベル]** を選択します。

1. **[秘密度ラベル]** ページで、**[+ 作成]**  >  **[ラベル グループ]** の順に選択します。

   >**注:** **[ラベル グループ]** オプションを使用できない場合は、最新のラベル スキーマに移行します。
   >
   > - **[最新のラベル スキーマに移行する]** バナーで **[開始]** を選択します。
   > - **[移行]** を選択し、**[移行の確認]** を選択します。
   > - 移行が完了するまで待ちます。 **[秘密度ラベル]** ページで **[ラベル グループ]** オプションが使用できるようになります。
   > - 次に、**[+ 作成]**  >  **[ラベル グループ]** の順に選択します。
...
1. **[このラベルのスコープを定義する]** ページで、**[ファイルと他のデータ資産]** と **[メール]** を選択します。 **[会議]** のチェック ボックスがオンになっている場合は、選択が解除されていることを確認します。

1. [**次へ**] を選択します。

1. **[選択した項目の種類の保護設定を選択する]** ページで、**[アクセスの制御]** オプションと **[コンテンツマーキングを適用する]** オプションを選択し、**[次へ]** を選択します。
...
1. 次のマーキングの種類ごとに、チェック ボックスをオンにし、**[テキストのカスタマイズ]** を選択してテキストを入力し、**[保存]** を選択します。
