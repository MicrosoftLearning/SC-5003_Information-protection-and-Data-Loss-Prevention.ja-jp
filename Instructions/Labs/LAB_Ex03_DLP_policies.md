...
1. **[保護する情報]** ダイアログで、**[エンタープライズ アプリケーションとデバイス]** を選択します。

1. **[テンプレートの利用またはカスタム ポリシーの作成]** ページで、**[カスタム]** を選択し、**[規制]** の下で **[カスタム ポリシー]** を選択します。
...
1. **[機密情報の種類]** ページで、Credit Card Number を検索して選択し、**[追加]** を選択します。**`Credit Card Number`**
...
1. **[ユーザー通知]** で、**[通知を使用してユーザーに通知し、機密情報の適切な使用についてユーザーを教育する]** を **[オン]** にし、**[ポリシー ヒントまたはメール通知を使用して Office 365 サービスのユーザーに通知する]** チェックボックスをオンにします。
...
1. **[ポリシー]** ページで、**[クレジット カードの DLP ポリシー]** チェックボックスをオンにし、**[ポリシーの編集]** (鉛筆アイコン) を選択して [ポリシーの構成] を開きます。
